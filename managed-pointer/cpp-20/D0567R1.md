...
* Implicit synchronization removed as future work for now as it requires static reflection.
...
It was suggested that it be possible for an implementation to optimise synchronization of a `managed_ptr` between particular execution contexts rather than having to synchronize via a host execution context. A solution that was being discussed but didn't make it into the first revision of the paper was the concept of channels. This is now supported in this paper and is described in section 3.5.
